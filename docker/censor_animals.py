"""
Censor animals in a video file using YOLOv8 object detection (OpenVINO/CPU).
...
def main():
    ...
    print("Model loaded on CPU (OpenVINO)")
    print()
    ...
    print(f"Muxing audio/subtitles with FFmpeg (libx264 re-encode)...")
